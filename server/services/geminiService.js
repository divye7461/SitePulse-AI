...
console.log("[DEBUG] Loaded GEMINI_API_KEY:", process.env.GEMINI_API_KEY ? `Yes (Starts with: ${process.env.GEMINI_API_KEY.substring(0, 7)})` : "No (Undefined!)");

const ai = new GoogleGenAI({
    apiKey: process.env.GEMINI_API_KEY
});

// Response schema optimized to prevent strict validation crashes
...
- Missing Alt Text: ${scrapedData.images.withoutAlt}
...
Extract top 10 keywords by frequency from the page content.`;
        ...
        // Using gemini-2.5-flash with safe schema constraints
